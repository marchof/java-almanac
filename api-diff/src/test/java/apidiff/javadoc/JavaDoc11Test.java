...
public class JavaDoc11Test extends JavaDocTestBase {
	...
	public void before() {
		...
		link_constructor = "http://javadoc.org/java.base/java/lang/Thread.html#<init>()";
		link_method_parameters ="http://javadoc.org/java.base/java/lang/Math.html#max(double,double)";
		link_method_array = "http://javadoc.org/java.base/java/lang/Runtime.html#exec(java.lang.String[])";
