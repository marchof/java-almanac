...
public class JavaDoc9Test extends JavaDocTestBase {
	
	@BeforeEach
	public void before() {
		javadoc = new JavaDoc9("http://javadoc.org/");
		...
		link_method_array = "http://javadoc.org/java/lang/Runtime.html#exec-java.lang.String:A-";
