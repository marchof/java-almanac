...
import apidiff.javadoc.JavaDoc5;
...
public enum JDK {
	...
	V6("6", "1.6.0_45-oracle", new JavaDoc5("https://docs.oracle.com/javase/6/docs/api/")),

	V7("7", "1.7.0_80-oracle", new JavaDoc5("https://docs.oracle.com/javase/7/docs/api/")),
