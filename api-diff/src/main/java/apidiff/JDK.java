...
public enum JDK {
	...
	V14("14", "14.0.0-open", new JavaDoc11("https://download.java.net/java/early_access/jdk14/docs/api/")),

	V15("15", "15.ea.15-open", new JavaDoc11("https://download.java.net/java/early_access/jdk15/docs/api/"));
