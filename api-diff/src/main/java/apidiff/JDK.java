...
public enum JDK {
	...
	V15("15", "15.ea.33-open", new JavaDoc11("https://download.java.net/java/early_access/jdk15/docs/api/")),

	V16("16", "16.ea.7-open", new JavaDoc11("https://download.java.net/java/early_access/jdk16/docs/api/"));
